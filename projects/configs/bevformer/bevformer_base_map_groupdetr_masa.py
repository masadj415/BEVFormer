...
vjepa_h_ = 28
vjepa_w_ = 50
vjepa_feat_h = vjepa_h_ * 16   # 448
vjepa_feat_w = vjepa_w_ * 16   # 800
...
train_pipeline = [
    ...
    dict(
        ...
        keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'gt_masks_bev']
    ),
]
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(vjepa_feat_w, vjepa_feat_h),
        pts_scale_ratio=1,
        flip=False,
        transforms=[
            dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='vjepa_448x800_bev200_map_groupdetr11_segw10',
                config=dict(
