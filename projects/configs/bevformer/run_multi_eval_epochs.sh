...
WORKDIR=${1:-/scratch/izar/tlphan/work_dirs/bevformer_small_map_groupdetr/13_May}   # usage: sbatch run_multi_eval_epochs.sh <your_workdir> <step>
STEP=${2:-4}          # evaluate every STEP epochs
TOTAL_EPOCHS=30
CONFIG=projects/configs/bevformer/bevformer_small_map_groupdetr.py
